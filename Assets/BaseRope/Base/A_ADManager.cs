...
public class A_ADManager : MonoBehaviour
{
    ...
    public string MAX_REWARD_ID = "857c0aedcc6e5929";
    public string MAX_INTER_ID = "e0870b0ebe6cd83d";
    ...
    public void playRewardVideo(Action<bool> OnRewardAdCompleted)
    {
        ...
        else
        {
            ...
            // A_GamePanel.Instance.ShowToast("Ad Not Ready");
            CowManager.Instance.ShowToast("Ad Not Ready");
            LoadRewardAd();
        }
    }
